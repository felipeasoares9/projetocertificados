                ...
                <tbody>
                    <?php foreach ($usuarios as $usuario) : ?>
                        <tr>
                            ...
                            <td><?php echo $usuario['inscricao']; ?></td>
                            <td><a href="confirmacao.php?id=<?php echo $usuario['id']; ?>&nome=<?php echo $usuario['nome']; ?>">Excluir</a>
                            |
                            <a href="gerenciarEvento.php?id=<?php echo $usuario['id']; ?>&nome=<?php echo $usuario['nome']; ?>">Atualizar</a>
                            |
                            <a href="pdf.php?id=<?php echo $usuario['id']; ?>&idpalestra=<?php echo $usuario['inscricao']; ?>">Gerar Certificado</a>
                            </td>
                        </tr>
                        <?php endforeach;?>
                </tbody>
